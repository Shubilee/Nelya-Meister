...
new Swiper('.partner-swiper-1', {
	...
	navigation: {
		...
		nextEl: '.partner-swiper-next-1',
		prevEl: '.partner-swiper-prev-1'
...
// let swiper = document.querySelector(".swiper-gallery");
...
// }
// )
let galleryItems = document.querySelectorAll(".gallery__items");
if (galleryItems.length) {
	galleryItems.forEach(galleryItem => {
		const links = galleryItem.querySelectorAll("._popup-link");
		if (links.length) {
...
if(langs.length){
	langs.forEach(lang => {
		let li = lang.querySelectorAll(".lang__li")
		// console.log(li);
		li.forEach(link => {
			link.addEventListener("click", function () {
